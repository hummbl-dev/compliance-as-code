# Receipt: compliance-as-code executable v0.1 packet
...
- `schemas/compliance-as-code-v0.1.json`
- `examples/compliance-evidence-v0.1.example.json`
- `fixtures/valid/compliance-evidence-v0.1.valid.json`
- `fixtures/invalid/compliance-evidence-v0.1.invalid.json`
- `receipts/compliance-as-code-v0.1-packet-receipt.md`
...
- No legal conclusions are made in this PR.
